  ...
  return (
    <div className="flex flex-col gap-xs">
      ...
      <input
        ...
        inputMode={inputMode}
        autoFocus={autoFocus}
        className={`h-12 w-full rounded-md border bg-surface px-md text-body text-text outline-none transition placeholder:text-muted disabled:opacity-50 ${borderClass}`}
      />
